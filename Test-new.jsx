...
const AssignLeadForm = (props) => {
  ...
  return (
    <div>
      <h1 className="assignLeadForm__title">
        {t("AssignLeadForm.assign_lead")}
      </h1>
      <div className="assignLeadForm__divider assignLeadForm__dividerTop" />

      <span className="assignLeadForm__customerNameTitle">
        {t("AssignLeadForm.customer_name")}
      </span>
      ...
      <h2 className="assignLeadForm__subHeading">
        {t("AssignLeadForm.assign_dealership_users_to_this_customer")}
      </h2>
        ...
        <AssignLeadModalUserList>
          {!props.currentLeadAssignees.length && (
            <li className="assignLeadForm__noAssignedUsers">
              {t("AssignLeadForm.no_users_have_been_assigned_yet")}
            </li>
          )}
